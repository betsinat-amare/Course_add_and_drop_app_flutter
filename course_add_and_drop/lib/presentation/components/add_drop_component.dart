    ...
    return Container(
      ...
      child: Text(
        ...
        style: const TextStyle(
          ...
          color:
              Color.fromARGB(255, 12, 95, 163), // Assuming colorHeading is blue
        ),
...
class HeadingHomeTextComponent extends StatelessWidget {
  ...
  const HeadingHomeTextComponent({Key? key, required this.value})
      : super(key: key);
...
class TextFieldPhotoComponent extends StatefulWidget {
  ...
  @override
  _TextFieldPhotoComponentState createState() =>
      _TextFieldPhotoComponentState();
}
...
class PasswordLoginTextFieldComponent extends StatefulWidget {
  ...
  @override
  _PasswordLoginTextFieldComponentState createState() =>
      _PasswordLoginTextFieldComponentState();
}

class _PasswordLoginTextFieldComponentState
    extends State<PasswordLoginTextFieldComponent> {
