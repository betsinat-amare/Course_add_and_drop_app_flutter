...
class SelectAcademicYearScreen extends StatefulWidget {
  ...
  @override
  _SelectAcademicYearScreenState createState() =>
      _SelectAcademicYearScreenState();
}
      ...
      body: Column(
        children: [
            ...
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    ...
                    const CircleAvatar(
                      ...
                      backgroundImage: AssetImage(
                          'assets/profile.png'), // Replace with actual user photo
                    ),
                  ],
                ),
                ...
                Align(
                  ...
                  child: add_drop_components.NormalTextComponent(
                      // Using NormalTextComponent for title
                      value:
                          'Select Academic Year and Semester'), // Adapted title
                ),
                ...
                Align(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                          color: Colors.grey), // Add border for clarity
                    ),
                  ...
                  child: Container(
                    ...
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton<String>(
                        ...
                        value: _addDropSelection.isEmpty
                            ? null
                            : _addDropSelection,
                        icon: const Icon(Icons.arrow_drop_down),
                        elevation: 16,
                        ...
                        onChanged: (String? newValue) {
                          setState(() {
                            ...
                            if (_addDropSelection == 'Add') {
                              context.go(
                                  '/courses/all'); // Navigate to Add Course screen
                            } else if (_addDropSelection == 'Drop') {
                              context.go(
                                  '/drop-course'); // Navigate to Drop Course screen
                            }
                          });
                        },
                        items: _addDropOptions
                            .map<DropdownMenuItem<String>>((String value) {
                          return DropdownMenuItem<String>(
                            value: value,
                            child: Text(value),
          ...
          BottomNavigationBar(
            ...
            selectedItemColor:
                const Color(0xFF3B82F6), // Purple color from image
