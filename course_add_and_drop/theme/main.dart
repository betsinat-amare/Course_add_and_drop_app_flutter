  ...
  void initState() {
    ...
    _router = GoRouter(
      ...
      redirect: (context, state) async {
        ...
        debugPrint(
          'GoRouter Redirect: Logged In (from Notifier): $loggedIn, Role: $role',
        );
        ...
        if (!loggedIn) {
          ...
          if (!isAuthPage &&
              targetPath != '/loading' &&
              targetPath != '/home') {
            // Added targetPath != '/home'
            debugPrint(
              'GoRouter Redirect: Not logged in and accessing protected page, redirecting to /home',
            );
            return '/home';
          }
          ...
          if (targetPath == '/loading') {
            debugPrint(
              'GoRouter Redirect: Not logged in and on /loading, redirecting to /home',
            );
            return '/home';
          }
          // If not logged in but trying to access an auth page (including home), allow it.
          debugPrint(
            'GoRouter Redirect: Not logged in, allowing access to auth page: $targetPath',
          );
        ...
        if (isAuthPage && targetPath != '/home') {
          // Added targetPath != '/home' here as well
          String homeRoute = (role == 'Registrar')
              ? '/dashboard/admin'
              : '/dashboard/user';
          debugPrint(
            'GoRouter Redirect: Logged in and on auth page ($targetPath), redirecting to home dashboard: $homeRoute',
          );
        ...
        if (loggedIn && targetPath == '/home') {
          debugPrint(
            'GoRouter Redirect: Logged in and accessing /home, allowing access.',
          );
          return null;
        }
